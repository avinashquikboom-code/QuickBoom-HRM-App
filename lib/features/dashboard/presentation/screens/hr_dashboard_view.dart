                    ...
                    Expanded(
                      child: GestureDetector(
                        onTap: () async {
                          ...
                          if (selected != null) {
                            ref.read(hrDashboardViewModelProvider.notifier).setSelectedMonth(selected);
                          }
                        },
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              if (dashboardState.selectedMonth != null)
                                GestureDetector(
                                  onTap: () => ref.read(hrDashboardViewModelProvider.notifier).clearFilters(),
                    ...
                    Expanded(
                      child: GestureDetector(
                        onTap: () async {
                          ...
                          if (selected != null) {
                            ref.read(hrDashboardViewModelProvider.notifier).setSelectedYear(selected);
                          }
                        },
                        child: Container(
                          padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
