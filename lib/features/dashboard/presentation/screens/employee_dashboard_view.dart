                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 2),
                            Text(
                              'View permissions or request new features',
                              style: TextStyle(
                                fontSize: 11,
                                color: AppColors.textSecondary,
                              ),
...
class _TodayPunchCardState extends ConsumerState<_TodayPunchCard> {
  ...
  Future<void> _handlePunch(BuildContext context) async {
    ...
    try {
      ...
      final shouldCheckGeofence = !widget.isCheckedIn 
          ? geofenceState.enableGeofence 
          : geofenceState.enablePunchOutGeofence;
              ...
              SnackBar(
                content: Row(
                  children: [
                    ...
                    const SizedBox(width: 10),
                    Expanded(
                      child: Text(widget.isCheckedIn
                          ? 'Punch blocked: You are outside the office geofence for punch out.'
