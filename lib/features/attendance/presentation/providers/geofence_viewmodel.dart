...
class GeofenceState {
  ...
  final bool enablePunchOutGeofence;
  ...
  const GeofenceState({
    ...
    this.enablePunchOutGeofence = false,
    this.distance,
    this.nearestOffice,
    this.maxRadius,
    this.offices = const [],
  ...
  GeofenceState copyWith({
    ...
    return GeofenceState(
      ...
      enablePunchOutGeofence: enablePunchOutGeofence ?? this.enablePunchOutGeofence,
  ...
  Future<bool> checkGeofenceStatus({double? latitude, double? longitude}) async {
    ...
    try {
      ...
      if (data['success'] == true) {
        ...
        final enablePunchOutGeofence = result['enablePunchOutGeofence'] ?? false;
        state = state.copyWith(
          isWithinGeofence: result['isWithinGeofence'] ?? false,
          enableGeofence: enableGeofence,
          enablePunchOutGeofence: enablePunchOutGeofence,
